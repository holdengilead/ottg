...
def _update_virtualenv(source_folder):
    ...
    aux_str = '{}/bin/pip install -r {}/requirements.txt'
    run(aux_str.format(virtualenv_folder, source_folder))
...
def _update_database(source_folder):
    aux_str = 'cd {} && ../virtualenv/bin/python manage.py migrate --noinput'
    run(aux_str.format(source_folder))
